function welcomeUserTemplate(name, lastName, email) {
  ...
  <a href="https://dev.serviapp.solutions/usuario/perfil" style="display: inline-block; background-color: #007bff; color: #fff; text-decoration: none; padding: 10px 20px; margin-top: 20px; border-radius: 5px;">Completar perfil</a>
