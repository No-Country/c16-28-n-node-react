function welcomeProvTemplate(name, lastName, email) {
    const contentHTML = `
    ...
    <p style="color: #666;">Ya puedes comenzar a completar tu perfil y registrar tus servicios en nuestra plataforma para conectar con tus nuevos clientes.</p>
    <h2>¡Muchas gracias por elegirnos!</h2>
    <a href="https://dev.serviapp.solutions/proveedor/perfil" style="display: inline-block; background-color: #007bff; color: #fff; text-decoration: none; padding: 10px 20px; margin-top: 20px; border-radius: 5px;">Completar perfil</a>
  ...
  module.exports = welcomeProvTemplate;
