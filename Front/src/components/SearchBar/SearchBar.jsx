...
const SearchBar = () => {
  ...
  return (
    <div className='bg-slate-800 p-4 flex justify-center items-center'>
        <div className='p-1 bg-white flex justify-center items-center rounded-full w-min'>
        ...
        <button className='bg-white p-2 text-black rounded-r-full border-gray border-l-2' onClick={handleSubmit}>
