...
export default function Login() {
    ...
    return (
            <div>
                <h1>Inicia sesión</h1>
                <form onSubmit={handleSubmit} className="p-4 flex flex-col items-center gap-6 border rounded-lg backdrop-blur-sm">
                    <p>Correo Electrónico<span className="font-sans text-red-800 text-text">*</span></p>
